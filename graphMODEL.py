...
class ModelGraph:
    ...
    def TrainModel(self):
        ...
        savefig1 = os.path.join(self.figtssdir, 'LA10')
        savefig2 = os.path.join(self.figtssdir, 'CM10')
        # ------------------------------------------------------
        ...
        model.save(r'C:\Users\gerar\PycharmProjects\EXPOR_TESIS\head_or10.keras')
